...
function content() {
    ...
    <Typography variant="h5" sx={{textAlign: 'left', ml: 15}}>
        ...
        <br/>
        <a href="https://play.google.com/store/apps/details?id=ru.mobint.pivmarket1&pcampaignid=web_sharep" target="_blank" rel="noreferrer">Android</a> или <a href="https://apps.apple.com/ru/app/%D0%BF%D0%B8%D0%B2%D0%BC%D0%B0%D1%80%D0%BA%D0%B5%D1%82-1/id6473837140" target="_blank" rel="noreferrer">IOS</a>
        <br/>
        <Box component="img" src={app} sx={{height:  200}} alt='app'/>
    </Typography>
    <br/>
    <Typography variant="h5" sx={{textAlign: 'left', ml: 15}}>
        2. Выполните регистрацию в приложении.
        <br/>
        <Box component="img" src={screen} style={{height: 500, borderRadius: 25, marginLeft: 30, marginTop: 10}} alt="app"/>
    </Typography>
...
function mobileContent() {
    ...
    <Typography variant="h5" sx={{textAlign: 'left', ml: 5}}>
        <br/>
        У Вас еще остались бонусы? 
        <br/>
        Мы бережно сохраним их и перенесем в новую систему лояльности.
        ...
        Ничего не будет потеряно!
        <br/>
        Для переноса баллов нажмите на кнопку ниже:
    </Typography>
    <br/>
    <Box sx={{textAlign: 'center', mb: 15}}>
    <Link to='card'><Button variant="contained" style={{backgroundColor: brown[300]}}>Перенести</Button></Link>
...
export default function Home() {
    ...
    return(<div 
    style={{ display: "flex", flexDirection: 'column', borderTop: 5, width: isMobile ? '100%' : 'auto'}}>
        <Paper elevation={6} sx={{ alignContent: 'center', height: 65, backgroundColor: brown[100]}}>
